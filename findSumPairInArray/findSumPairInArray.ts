...
const findSumPairInArray = (numArr: number[], sum: number) => {
    // ! nested loop
    ...
    // if numArr is sorted, search from both ends for a sum
...
const findSumPair = (numArr: number[], sum: number) => {
    for (let index = 0; index < numArr.length; index++) {
        ...
        // ! nested complexity with indexOf()
